...
const actionLabels: Record<string, { label: string; token: string }> = {
  ...
  season_created: { label: "Temporada criada", token: "var(--state-played)" },
  season_edited: { label: "Temporada editada", token: "var(--state-active)" },
  season_activated: { label: "Temporada ativada", token: "var(--state-played)" },
  season_closed_manual: { label: "Temporada encerrada", token: "var(--state-noshow)" },
  season_auto_closed: { label: "Temporada encerrada (auto)", token: "var(--state-noshow)" },
  season_reopened: { label: "Temporada reaberta", token: "var(--state-scheduled)" },
  season_archived: { label: "Temporada ocultada", token: "var(--state-scheduled)" },
  season_restored: { label: "Temporada restaurada", token: "var(--state-played)" },
  season_news_deleted: { label: "Notícia de temporada removida", token: "var(--state-tbd)" },
};
